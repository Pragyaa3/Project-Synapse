...
export async function analyzeVoiceTranscript(transcript) {
  const prompt = `Analyze this voice note transcript and extract detailed information:

"${transcript}"

Return ONLY valid JSON (no markdown, no backticks):
{
  "keywords": ["important", "searchable", "keywords", "from", "audio"],
  "tags": ["relevant", "category", "tags"],
  "tone": "excited|important|casual|urgent|thoughtful|professional|personal",
  "sentiment": "positive|negative|neutral|mixed",
  "summary": "one sentence summary of main idea",
  "mainTopics": ["main", "topics", "discussed"],
  "actionItems": ["any", "tasks", "or", "todos", "mentioned"],
  "entities": ["people", "places", "organizations", "mentioned"],
  "contentType": "idea|todo|reminder|note|meeting|thought|plan"
}

Extract as much relevant information as possible to make this voice note searchable and useful.`;
